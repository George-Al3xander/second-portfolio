    ...
    <section className="h-[calc(100vh-12rem)] w-[min(90%,40rem)]  mx-auto text-center flex flex-col gap-10">
        ...
        >
            <p className="leading-xl opacity-60 ">
                Looks like you&apos;ve wandered off the path. This is just a
                one-page portfolio, so there&apos;s not much else to see here.
                Feel free to explore by going to another unexciting path or
